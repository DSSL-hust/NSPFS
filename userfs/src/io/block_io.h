...
int userfs_write(struct buffer_head *bh);
int userfs_write_ssd(uint8_t devid,uint8_t *buf,uint64_t offset, size_t size);
int userfs_direct_write(int fd, uint8_t *buf,uint64_t block_nr, size_t size);
int userfs_io_wait(uint8_t dev, int isread);
