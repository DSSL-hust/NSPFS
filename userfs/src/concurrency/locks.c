...
void userfs_spin_lock(struct userfs_spinlock *lk)
{
	while (1)
	{
...
void userfs_spin_unlock(struct userfs_spinlock *lk)
{
	lk->lock = 0;
}
...
#if 0
int userfs_mutex_lock(struct userfs_mutex *mu)
{
	int i, c;
...
#endif
int userfs_mutex_lock(union userfs_mutex *m)
{
	int i;
...
int userfs_mutex_unlock(userfs_mutex_t *m)
{
	int i;
...
int userfs_mutex_trylock(userfs_mutex_t *m)
{
